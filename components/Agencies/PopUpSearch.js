...
class PopUpSearch extends Component {
  ...
  handleSearch = (search) => {
    ...
    this.setState({ selectedRow: {}, filteredData: filterData || [] });
  };
  ...
  render() {
    ...
    const { datas, isSearch, page, size, selectedRow, filteredData } =
      this.state;
    ...
    return (
      <>
        <Modal
          ...
          footer={null}
        >
          <ModalHeaderWrapper>Cơ quan ban hành</ModalHeaderWrapper>
          <FormWrapper>
            <>
              <ModalContentWrapper>
                <Row gutter={36} align="bottom">
                  <Col span={24}>
                    <AlignBottomItem label="Tên cơ quan ban hành" {...ITEM_COL}>
