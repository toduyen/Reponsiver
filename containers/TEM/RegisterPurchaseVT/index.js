...
class Page extends React.Component {
  ...
  onReject = async ({ pdndung: lyDo }) => {
    ...
    await dispatch(rejectTEMPurchase(jwt, { id, lyDo, trangThai: 4 }));
  };
  ...
  renderModal = () => {
    const { showModal, dataProposal, dataAnnouncement } = this.state;
    return (
      <>
    ...
    return (
      <>
        ...
        <PageTitleWrapper className="title-search">
          Văn thư ký ban hành thông báo tiếp nhận, xử lý đăng ký mua TEM
        </PageTitleWrapper>
        <PageFormWrapper>
