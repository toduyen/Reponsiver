...
const TB01QTRHDDT = (invoiceData) => {
  ...
  const w = window.open("");
  w.document.write(`
      <html><head><title>Mẫu số: 04 ${moment().valueOf()} </title><style>
        ${STYLE_HD_CSS}
 ...
 <div class="main-page">
      <div class="heading-content">
        ...
        <div class="title-heading">
          <h2 class="main-title">HÓA ĐƠN BÁN HÀNG DỰ TRỮ QUỐC GIA</h2>
          ${getTitle()}
        </div>
      </div>
          ...
          <table class="res-tb">
            <thead style="text-align: center">
              <tr>
                ...
                <th class="tb-thh">Tên tài sản</th>
