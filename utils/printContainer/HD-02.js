...
const TB01QTRHDDT = (invoiceData) => {
  ...
  w.document.write(`
      <html><head><title>Mẫu số: 02 ${moment().valueOf()} </title><style>
        ${STYLE_HD_CSS}
 ...
 <div class="main-page">
      <div class="heading-content">
        ...
        <div class="title-heading">
          <h2 class="main-title">HOÁ ĐƠN BÁN HÀNG</h2>
          ${getTitle()}
        </div>
      </div>
              ...
              invoiceData?.hdhhdvu
                ? invoiceData.hdhhdvu
                    ...
                    ${getPlus(
                      invoiceData?.tchat,
                      v.dgia
                    )}${formatCurrencyNumber(v.dgia)}
                    </td>
                    <td class="tx-center">
                    ${getPlus(
                      invoiceData?.tchat,
                      v.stckhau
                    )}${formatCurrencyNumber(v.stckhau)}
                    </td>
                    <td class="tx-center">
                    ${getPlus(
                      invoiceData?.tchat,
