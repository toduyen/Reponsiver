...
const TB01QTRHDDT = (invoiceData) => {
  ...
  const getTitle = () => {
    ...
    return `<div type="flex" justify="center" class="day">
        ${
          khdon === 1
            ? `<div class="mg-bottom">
            HOÁ ĐƠN BÁN HÀNG DÀNH CHO TỔ CHỨC, CÁ NHÂN TRONG KHU PHI THUẾ QUAN
          </div>`
            : ""
        }
        ${
          khdon === 2 && hdon === "01"
            ...
            HOÁ ĐƠN BÁN HÀNG KIÊM TỜ KHAI HOÀN THUẾ
          </div>`
            : ""
        }
        ${
  ...
  const renderGTGT = `<div class="content-info">
            ...
            <table class="res-tb">
              ...
              ${
                invoiceData.thttltsuat
                  ...
                  <td class="tx-center">
                  ${getPlus(invoiceData?.tchat, v.tthue)}${formatCurrencyNumber(
                            v.tthue
                          )}
                  </td>
                </tr>`
  ...
  const renderBH = `<div class="content-info">
  <ul class="list-fill-out">
    <li>
      <div class="data-item">
        <div class="di-label">
  ...
  <table class="res-tb">
    ...
    <tr>
      ...
      <th class="tb-sl">Số lượng</th>
      <th class="tb-dg">Đơn giá</th>
      <th class="tb-ttct">Chiết khấu</th>
      <th class="tb-ttgd">Thành tiền</th>
    </tr>
    </thead>
    <tbody>
    ${
      invoiceData?.hdhhdvu
        ? invoiceData.hdhhdvu
            ...
            <td class="tx-center">
            ${getPlus(invoiceData?.tchat, v.stckhau)}${formatCurrencyNumber(
                  v.stckhau
                )}
            </td>
            <td class="tx-center">
    ...
    formatCurrencyNumber(invoiceData.tgtttbso) || ""
              ...
              <tr>
                <td class="tx-center">Ghi chú</td>
                <td class="tx-center">${invoiceData?.gchu || ""}</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  const content = isEmpty(invoiceData?.thttltsuat) ? renderBH : renderGTGT;

  const time = moment(invoiceData?.nky || invoiceData?.ntky);

  const w = window.open("");
  w.document.write(`
      <html><head><title>Mẫu số: 05 ${moment().valueOf()} </title><style>
          ${STYLE_HD_CSS}
 ...
 <div class="main-page">
      <div class="heading-content">
        ...
        <div class="title-heading">
          <h2 class="main-title">HOÁ ĐƠN KHÁC</h2>
          ${getTitle()}
        </div>
      </div>
