  ...
  const getTitle = () => {
    ...
    return `<div type="flex" justify="center" class="day">
        ${
          khdon === 1
            ? `<div class="mg-bottom">
            PHIẾU XUẤT KHO KIÊM VẬN CHUYỂN NỘI BỘ DÀNH CHO TỔ CHỨC, CÁ NHÂN
        ...
        ${
          khdon === 2 && hdon === "01"
            ...
            PHIẾU XUẤT KHO KIÊM VẬN CHUYỂN NỘI BỘ KIÊM TỜ KHAI HOÀN THUẾ
          </div>`
            : ""
        }
        ${
 ...
 <div class="main-page">
      <div class="heading-content">
        ...
        <div class="title-heading">
          <h2 class="main-title">PHIẾU XUẤT KHO KIÊM VẬN CHUYỂN NỘI BỘ</h2>
          ${getTitle()}
        </div>
      </div>
      ...
      <div class="content-info">
          <ul class="list-fill-out">
            ...
            <li>
              <div class="data-item">
                <div class="di-label">
                    <span>Địa chỉ (Địa chỉ kho xuất hàng):</span>
                </div>
                <div class="di-value">
            ...
            <li>
              <div class="data-item">
                <div class="di-label">
                    <span>Lệnh điều chuyển nội bộ:</span>
                </div>
                <div class="di-value">
                    <div>${invoiceData?.nblddnbo || ""}</div>
                </div>
              </div>
            </li>
            <li>
